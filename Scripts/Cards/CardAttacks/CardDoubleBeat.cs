...
public partial class CardDoubleBeat : CardAttack
{ 
    public static new CardDoubleBeat Instance() => GD.Load<PackedScene>("res://Scenes/Cards/CardAttacks/card_double_beat.tscn").Instantiate<CardDoubleBeat>();
    ...
    public override List<string> TakeEffect(List<BattlePiece> battlePieces)
    {
        ...
        foreach (var piece in battlePieces)
        {
            ...
            var actionInfo = new string($"{Tr("T_USE")} {Tr("CARD_DOUBLE_BEAT")}\n");
