...
public static class CardData
{
    ...
    public static List<CardInfo> CardList = new() { CAStrike, CABash, CADoubleBeat, CDDefend, CDConsolidate, CSSurvive, CSStruggle, CSShieldStrike, CIECS, CIUST, CSCure, CSFury };
}
