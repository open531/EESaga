...
public partial class Make : BattleEnemy
{
    [Signal] public delegate void MakeActionEventHandler(string actionInfo, string actionEffect, bool refreshLastLabel);
    public static new Make Instance() => GD.Load<PackedScene>("res://Scenes/Entities/BattleEnemies/make.tscn").Instantiate<Make>();

    public override void _Ready()
    {
        base._Ready();
        PieceName = "E_MAXWHEAT";
        HealthMax = 10;
        Health = HealthMax;
        Agility = 1;
        MoveRange = 3;
    ...
    public override void Attack(BattleParty battleParty)
    {
        ...
        EmitSignal(SignalName.MakeAction, actionInfo, damageInfo, true);
    }
